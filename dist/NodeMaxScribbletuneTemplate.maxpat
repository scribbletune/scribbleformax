...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 99.0, 213.0, 25.0 ],
					"text" : "Installation"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 549.5, 41.0, 150.0, 20.0 ],
					"text" : "notes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 658.0, 387.0, 227.0, 34.0 ],
					"text" : "This dictionary contains the Scribbletune clip created in the node script"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 915.0, 329.0, 225.0, 34.0 ],
					"text" : "This script contains all the logic for the creation of the Scribbletune clip"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 698.0, 205.0, 198.0, 34.0 ],
					"text" : "We collect all the optional parameters in this dictionary"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 553.5, 61.0, 100.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 35.0, 54.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "C1", "C2", "CM" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 594.0, 286.0, 59.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 74.0, 59.0, 22.0 ],
					"text" : "makeClip"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 594.0, 434.0, 99.0, 22.0 ],
					"text" : "templateAPIpass"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 594.0, 329.0, 305.0, 22.0 ],
...
,
					"text" : "node.script nodeScribbletune.js @autostart 1 @watch 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 594.0, 205.0, 91.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "dictionary", "", "", "" ],
					"patching_rect" : [ 594.0, 387.0, 55.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 594.0, 479.0, 111.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "templateAPIpass",
						"parameter_enable" : 0
					}
,
					"text" : "js templateAPIpass"
				}
